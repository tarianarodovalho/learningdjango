...
class QuestionIndexViewTests(TestCase):
    ...
    def test_past_question(self):
        ...
        """
        create_question(question_text="Pergunta antiga.", days=-30)
        response = self.client.get(reverse('polls:index'))
    ...
    def test_two_past_questions(self):
        ...
        """
        create_question(question_text="Pergunta antiga 1.", days=-30)
        create_question(question_text="Perguta antiga 2.", days=-5)
        response = self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(
            response.context['latest_question_list'],
            ['<Question: Pergunta antiga 2.>', '<Question: Pergunta antiga 1.>']
        )
...
class QuestionDetailViewTests(TestCase):
    ...
    def test_past_question(self):
        ...
        """
        past_question = create_question(question_text='Pergunta antiga.', days=-5)
